...
import rcp.dialogs.HistoryTestExecutionDialog;
...
public class OpenHistoryTestExecutionAction extends Action implements
		ISelectionListener {
	...
	public OpenHistoryTestExecutionAction(IWorkbenchWindow window) {
		super();
		this.window = window;
		setText("Executions history");
	...
	public ImageDescriptor getImageDescriptor() {
		...
		return AbstractUIPlugin.imageDescriptorFromPlugin(Activator.PLUGIN_ID, "icons/bookmark.gif");
	}
	...
	public void run() {
		...
		if(sel != null){
			new HistoryTestExecutionDialog(this.window.getShell(), p, tp, ti, sel).open();
		}
