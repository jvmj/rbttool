...
import rcp.dialogs.NewQuestionDialog;
...
public class ManageQuestionsWindow extends ApplicationWindow/* implements ISelectionListener*/{
	...
	public ManageQuestionsWindow(Shell parentShell, Project p, Questionnaire q) {
		super(parentShell);
		this.project = p;
	...
	protected Control createContents(Composite parent) {
		...
		this.getShell().setText("Questions management area");
