...
public class EditProjectDialog extends Dialog {
	...
	public EditProjectDialog(Shell parentShell, Project p) {
		super(parentShell);
		this.project = p;
	...
	protected void configureShell(Shell newShell) {
		...
		newShell.setText("Project details");
	...
	protected Control createDialogArea(Composite parent) {
		...
		nameText.setText(this.project.getName());
		...
		startDateText.setText(this.project.getStartDate());
		...
		dueDateText.setText(this.project.getDueDate());
		...
		mainDescriptionText.setText(this.project.getMainDescription());
		...
		requirementBaseLineText.setText(this.project.getRequirementBaseline());
...
/*		resourcesText = new Text(composite, SWT.MULTI | SWT.BORDER | SWT.WRAP | SWT.V_SCROLL);
		...
		Vector<String> resources = this.project.getResources();
		if(resources != null){
			
			for (int i = 0; i < resources.size(); i++) {
				t.add(resources.elementAt(i));
			}
		}
